...
#endif
/* Tokens.  */
#define COMMENT_START 258
#define COMMENT_END 259
#define SPACE 260
#define NEW_LINE 261
#define LABEL_END 262
#define LABEL 263
#define CODE 264
#define COMMENT 265
...
{
  "$end", "error", "$undefined", "COMMENT_START", "COMMENT_END", "SPACE",
  "NEW_LINE", "LABEL_END", "LABEL", "CODE", "COMMENT", "$accept",
  "Program", "Whitespace", YY_NULLPTR
};
#endif
...
{
       4,     2,     5,     6,     9,     7,     8,    10,    11,     5,
      12,    13,     5,    14,     5,    15
};

static const yytype_uint8 yycheck[] =
{
       3,     0,     5,     6,    10,     8,     9,     7,     8,     5,
       4,     7,     5,    13,     5,     6
};
...
#line 47 "parser.y" /* yacc.c:1646  */
    { offset = offset + calculate_length((yyvsp[-1].string));}
...
#line 48 "parser.y" /* yacc.c:1646  */
    {
                                                                                  if(find_symbol(table, table_index, (yyvsp[-4].string)) == -1)
                                                                                  {
                                                                                    set_symbol(table, table_index, (yyvsp[-4].string), offset);
                                                                                    table_index++;
                                                                                  }
                                                                                  else
                                                                                  {
