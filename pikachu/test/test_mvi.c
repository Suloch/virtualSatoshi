...
int test_mvi_main()
{
  ...
  */
  ...
  /*test Memory with 0 value
  */
  test_mvi("PI PI PIKA PIKA PIKA PIKACHU PIKA PI PIKACHU PIKACHU PIKA PI PIKACHU PIKACHU PI PI PI PIKA PIKACHU PI PIKA PIKA PIKA PIKA PIKA PIKA PIKA PIKA PIKA PIKA", 6, 0);

  /*test Memory with 13 value
  */
  test_mvi("PI PI PIKA PIKA PIKA PIKACHU PIKA PI PIKACHU PIKACHU PIKA PI PIKACHU PIKACHU PI PI PI PIKA PIKACHU PI PIKA PIKA PIKA PIKA PIKA PIKA PIKA PIKACHU PIKACHU PIKACHU", 6, 13);

  /*test Memory with -1231 value
  */
  test_mvi("PI PI PIKA PIKA PIKA PIKACHU PIKA PI PIKACHU PIKACHU PIKA PI PIKACHU PIKACHU PI PI PI PIKA PIKACHU PI PIKA PIKA PI PIKACHU PIKACHU PIKA PI PIKACHU PIKACHU PI", 6, -1231);
